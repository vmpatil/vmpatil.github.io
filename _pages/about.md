...
Welcome! I am a fifth-year Ph.D. candidate in the [Operations Research](https://www.cmu.edu/tepper/faculty-and-research/academic-areas/operations-research) program at Carnegie Mellon University, where I am advised by [Gérard Cornuéjols](https://www.andrew.cmu.edu/user/gc0v/). My research sits at the intersection of integer programming, discrete optimization, and lattice theory, with additional interests in convex optimization, network optimization, and data-driven decision-making. Before my Ph.D., I received a B.Sc. in Industrial Engineering from the University of Wisconsin–Madison in 2022, where I was advised by [Yonatan Mintz](https://engineering.wisc.edu/directory/profile/yonatan-mintz/).
...
You can find my CV [here](https://vmpatil.github.io/files/Sept13_academic_cv.pdf).
...
- **Aug 2024**: Co-chaired the YinzOR Student Conference.
- **Mar 2024**: Co-chaired a session and gave a talk on *Prescriptive 0-1 Neural Networks for Personalized Medicine* at the INFORMS Optimization Society Conference, Houston, TX.